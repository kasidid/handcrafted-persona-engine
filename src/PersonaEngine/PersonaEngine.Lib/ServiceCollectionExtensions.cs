        ...
        services.AddSingleton<IRealtimeSpeechTranscriptor>(sp =>
                                                           {
                                                               ...
                                                               var realtimeSpeechTranscriptorOptions = new RealtimeSpeechTranscriptorOptions {
                                                                                                                                                 AutodetectLanguageOnce        = asrOptions.AutodetectLanguageOnce,        // Flag to detect the language only once or for each segment
                                                                                                                                                 ...
                                                                                                                                                 LanguageAutoDetect            = asrOptions.LanguageAutoDetect,            // Flag to auto-detect the language
                                                                                                                                                 Language                      = CultureInfo.GetCultureInfo(asrOptions.Language), // Language to use for transcription
